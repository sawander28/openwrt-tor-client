...
opkg install curl ethtool netcat nmap-ssl socat ss tcpdump
opkg install tor torsocks
opkg install snowflake-client snowflake-daemon snowflake-broker
...
PS1='\[\e]0;\u@\h:\w\007\e[01;31m\]\h\[\e[01;34m\] \w \$\[\e[00m\] '
